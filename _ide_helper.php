 ...
 * Generated for Laravel 5.1.1 (LTS) on 2015-06-09.
 *
...
namespace {
    ...
    class Asset extends \Serafim\Asset\Facade{
        ...
        public static function make($path, $options = array()){
            return \Serafim\Asset\Compiler::make($path, $options);
        }
        ...
        public static function addCompiledFile($file){
            return \Serafim\Asset\Compiler::addCompiledFile($file);
        }
        ...
        public static function getCompiledFiles(){
            return \Serafim\Asset\Compiler::getCompiledFiles();
        }
        ...
        public static function manifest(){
            return \Serafim\Asset\Compiler::manifest();
        }
